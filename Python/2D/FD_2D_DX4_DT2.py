...
# Receiver¿×´»’..Ç-
xrec1 = 100
yrec1 = 80   # Position Reciever 1 (in grid points)
xrec2 = 100
yrec2 = 100  # Position Reciever 2 (in grid points)
xrec3 = 100
yrec3 = 120  # Position Reciever 3 (in grid points)


# Velocity and density
rho = 2.2
vp = 3000.0
vp_grid = vp * np.ones((ny, nx))
rho_grid = rho * np.ones((ny, nx))
...
lame_lambda = rho_grid * vp_grid * vp_grid
...
for n in range(2, nt):
        ...
        for kx in range(5,nx-4):
            for ky in range(5,ny-4):
                ...
                p[ky,kx] = p[ky,kx] - lame_lambda[ky,kx] * dt * (vx_x + vy_y)
